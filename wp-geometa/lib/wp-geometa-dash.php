...
class WP_GeoMeta_Dash {
	...
	public function admin_enqueue_scripts( $hook ) {
		...
		wp_enqueue_script( 'leafletjs', $plugin_dir . 'assets/images/leaflet.js', array(), null );
		wp_enqueue_style( 'leafletcss', $plugin_dir . 'assets/css/leaflet.css', array(), null );
		wp_enqueue_style( 'wpgeometadash', $plugin_dir . 'assets/wpgeometa.css', array( 'leafletcss' ) );

		wp_register_script( 'wpgeometadashjs', $plugin_dir . 'assets/wpgeometa.js', array( 'leafletjs' ) );
